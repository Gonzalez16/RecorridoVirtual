...
>>>>>>> Stashed changes:TourTec/index.js
  ...
  /*
  function pertenecenA(scene,indice){
    let siguienteElemento = indice + 1 < scene.length && data.scenes[indice].edificio == data.scenes[indice+1].edificio ? "true" : "false"
    console.log('Edificio '+ data.scenes[indice].edificio + ' de la escene '+ data.scenes[indice].id + ' En la posicion ' + (indice) + ' le sigue el indice ' + (indice+1) + ' , ' + (siguienteElemento));
  }*/
  ...
  //modificar la funcion switchscene
